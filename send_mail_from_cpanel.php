...
// $mail->setFrom('info@kdcloveembassy.com', 'First Last');
// //Set an alternative reply-to address
// $mail->addReplyTo('info@kdcloveembassy.com', 'rst Last');
// //Set who the message is to be sent to
// $mail->addAddress('apprealms@gmail.com', 'John Doe');
...
/*
$mysql = mysqli_connect('localhost', 'kdclovee_kdc', 'E.-[1SW355TA]Vp(');
mysqli_select_db($mysql, 'kdclovee_kdc');
